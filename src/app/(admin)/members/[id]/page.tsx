...
import {MemberCountModel, MemberDetailModel} from "@/types/member.type";
...
export default function MemberDetail() {
    ...
    const [countData, setCountData] = useState<MemberCountModel>();
            ...
            <div className="box-flex gap12 a-start">
                <div className="container-default fs-0 w400 pa24">
                    ...
                    {detailData?.status === "활성" ? (
                        ...
                        (
                            <>
                                <div className={styles.labelData}>탈퇴 일시</div>
                                <div className={styles.boxData}>{detailData?.lastLoginAt}</div>
                            </>
                        )
                    }
                ...
                <div className="fg1 container-default pa20">
                    ...
                    >
                        ...
                        <div className="fg1">
                            <div className="fs28 fw700">
                                {countData && countData.applyCount}
                            </div>
                            <div>
                                신청한 행사 수
                            </div>
